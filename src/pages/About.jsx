...
export default function About() {
  return (
    <main>
      <section className="page-hero"><div className="container"><span className="eyebrow">אודות</span><h1>מוסך בני — מקצועיות עם יחס אישי</h1></div></section>
      <section className="section about-section">
        <div className="container about-grid">
          <div>
            <span className="eyebrow dark">מי אנחנו</span>
            <h2>שקיפות, מקצועיות ושירות בגובה העיניים</h2>
            <p>אנחנו מאמינים שטיפול ברכב מתחיל בהסבר ברור. לפני כל עבודה מסבירים מה נמצא, מה האפשרויות ומה העלות המשוערת.</p>
